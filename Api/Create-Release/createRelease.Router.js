...
const {releseInfoPost,primaryArtistPost,submissionPost,primaryArtistGet,featuringArtisttGet,featuringArtisttPost,releseInfoGetOne,releseInfoGetAll,songsInfoPost,platformPost,submissionGet,catalogsGet,genreGet,languageGet} = require("./createRelease.Controller");
...
router.post("/submissionPost", submissionPost);
